...
- (void)configUI
{
    ...
    [userTF setAttributedPlaceholder:[[NSAttributedString alloc]initWithString:@"手机号" attributes:@{NSForegroundColorAttributeName:RGB(153, 153, 153)}]];
    ...
    registeredBtn.frame = CGRectMake(216*SCREENW_RATE, CGRectGetMaxY(lineV3.frame)+6*SCREENW_RATE, 98*SCREENW_RATE, 11*SCREENW_RATE);
    [registeredBtn setTitle:@"已有账号,前去登录" forState:UIControlStateNormal];
    [registeredBtn setTitleColor:RGB(53, 195, 236) forState:UIControlStateNormal];
    registeredBtn.titleLabel.font = [UIFont systemFontOfSize:11];
