...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    {
        UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, SCREENW, 141*SCREENW_RATE)];
        ...
        _anserUserName = [[UILabel alloc]initWithFrame:CGRectMake(12*SCREENW_RATE, CGRectGetMaxY(introL.frame)+10*SCREENW_RATE, 100*SCREENW_RATE, 14*SCREENW_RATE)];
        _anserUserName.textColor = RGB(102, 102, 102);
        _anserUserName.font = [UIFont systemFontOfSize:12];
        _anserUserName.text = @"已采纳";
